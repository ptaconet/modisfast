...
- the same 30 days-long times series of [GPM IMERG Final Precipitation L3 1 day 0.1 degree x 0.1 degree](https://doi.org/10.5067/GPM/IMERGDF/DAY/06) (collection="GPM_L3/GPM_3IMERGDF.06")

<details><summary>Map of the region of interest (click to expand)</summary>
<p>

```{r plot_roi, eval = T, message=F,echo=F, fig.align = 'left'}
require(tmap)
require(tmaptools)
...
Above are some packages that enable to download some of the data that are proposed through opendapr, along with some of their characteristics :
