...
| :-------------------------------------------------- | :-------------: | :-------------: |  :-------------: | :-------------: | 
| [`modisfast`](https://github.com/ptaconet/modisfast)      | MODIS, VIIRS, GPM |  `r emo::ji("white heavy check mark")` |  `r emo::ji("white heavy check mark")`  |   `r emo::ji("white heavy check mark")`  
| [`MODIS`](https://github.com/MatMatt/MODIS)       | MODIS  |  `r emo::ji("white heavy check mark")` |  `r emo::ji("cross mark")`  |  `r emo::ji("cross mark")`  
| [`MODIStsp`](https://github.com/ropensci/MODIStsp)   |  MODIS |  `r emo::ji("white heavy check mark")` |   `r emo::ji("cross mark")`   |  `r emo::ji("white heavy check mark")` 
| [`MODISTools`](https://github.com/ropensci/MODISTools)  |  MODIS and VIIRS (but not all collections)  |  `r emo::ji("white heavy check mark")` |   `r emo::ji("white heavy check mark")`   |   `r emo::ji("white heavy check mark")` 
| [`appeears`](https://github.com/bluegreen-labs/appeears)  |  MODIS, VIIRS, and many others  |  `r emo::ji("white heavy check mark")` |   `r emo::ji("white heavy check mark")`   |   `r emo::ji("white heavy check mark")` 
...
And finally, open the data in R as a `terra::SpatRaster` object using the function `mf_import_data()` (see [here](https://ptaconet.github.io/modisfast/articles/get_started.html#warning-import) why you should use this function, instead of the original `terra::rast()`, in the context of `modisfast`) :
...
`modisfast` converts the spatial, temporal and dimensional filters provided by the user in the function `mf_get_url()` into the appropriate URLs. Subsequently, the function `mf_download_data()` allows for downloading the data using the [`httr`](https://cran.r-project.org/web/packages/httr/index.html) and `parallel` packages. 
