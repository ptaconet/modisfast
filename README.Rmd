...
1. With the function **`odr_get_url()`**, get the URL(s) of the data for:
  
  * a collection : see [next section](#coll-available),
  * variables,
  * region of interest (`sf`/`sfc` polygons),
  * time range,
