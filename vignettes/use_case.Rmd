---
title: "3. Full example - use case"
author: "Paul Taconet"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Full example - use case}
...
res_dl_modis <- mf_download_data(urls_mod11a2)
res_dl_gpm <- mf_download_data(urls_gpm)
...
entomological_data$LST_1_month_bef <- LST_1_month_bef
entomological_data$rain_1_month_bef <- rain_1_month_bef
```

## Visualize the association between the abundance of mosquitoes and the meteorological variables
...
ggplot(entomological_data,aes(x=LST_1_month_bef, y=n)) + geom_point() + geom_smooth()

# association between rainfall and mosquito abundance
ggplot(entomological_data,aes(x=rain_1_month_bef, y=n)) + geom_point() + geom_smooth()
