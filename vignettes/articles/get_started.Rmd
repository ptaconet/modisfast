...
# import MOD11A1.061
modis_ts <- mf_import_data(path = file.path(target_fold,"data","Korhogo","MOD13A3.061"), 
                           collection = "MOD13A3.061")
# import GPM
gpm_ts <- mf_import_data(path = file.path(target_fold,"data","Korhogo","GPM_3IMERGM.07"), 
                         collection = "GPM_3IMERGM.07")
