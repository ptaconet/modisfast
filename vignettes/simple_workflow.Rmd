...
vignette: >
  %\VignetteIndexEntry{Simple workflow}
...
## Set ROI, time range and connect to USGS with your credentials
...
## Get the OPeNDAP URLs to download the data {#get-url}
