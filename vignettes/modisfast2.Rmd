...
modis_ts_korhogo <- mf_import_data(file.path(target_fold,"Korhogo","MOD11A1.061"), collection_source = "MODIS")
modis_ts_diebougou <- mf_import_data(file.path(target_fold,"Diebougou","MOD11A1.061"), collection_source = "MODIS")
